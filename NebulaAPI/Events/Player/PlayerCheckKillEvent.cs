...
/// </summary>
public class PlayerCheckKillEvent : AbstractPlayerEvent
{
    ...
    internal PlayerCheckKillEvent(Virial.Game.Player player, Virial.Game.Player killer, bool isMeetingKill, CommunicableTextTag playerState, CommunicableTextTag? eventDetail) : base(player)
    {
        Killer = killer;
